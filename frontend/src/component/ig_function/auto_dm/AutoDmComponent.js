    ...
    const showForm = () => {
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formBasicHashtag">
                <Form.Label>依據Hashtag</Form.Label>
            ...
            <Form.Group className="mb-3" controlId="formBasicTargetAccount">
                <Form.Label>依據某帳號粉絲</Form.Label>
                <Form.Control type="txt" name="targetAccount" value={inputs.targetAccount || ""} onChange={handleChange}  />
            </Form.Group>
            
            <Form.Group className="mb-3" controlId="formBasicMaximumDmAmount">
                <Form.Label>隨機私訊數</Form.Label>
                <Form.Select name="maximumDmAmount" value={inputs.maximumDmAmount || ""} onChange={handleChange}>
            ...
            <Form.Group className="mb-3" controlId="formBasicMessage">
                ...
                <Form.Control as="textarea" type="txt" name="message" value={inputs.message || ""} onChange={handleChange}  />
            </Form.Group>
    ...
    return (
        <Container className="p-3">
            <Container className="p-5 mb-4 bg-light rounded-3">
                <h1 className="header">自動私訊功能頁面</h1>
                {showForm()}
            </Container>
        </Container>
    )
